function solve(speed, area) {
  ...
  if (area === "motorway") {
    if (speed <= motorway) {
      ...
      console.log(
        `The speed is ${difference} km/h faster than the allowed speed of ${motorway} - ${status(
          difference
        )}`
      );
    }
    ...
    if (speed <= interstate) {
      ...
      console.log(
        `The speed is ${difference} km/h faster than the allowed speed of ${interstate} - ${status(
          difference
        )}`
      );
    }
    ...
    if (speed <= city) {
      ...
      console.log(
        `The speed is ${difference} km/h faster than the allowed speed of ${city} - ${status(
          difference
        )}`
      );
    }
    ...
    if (speed <= residential) {
      ...
      console.log(
        `The speed is ${difference} km/h faster than the allowed speed of ${residential} - ${status(
          difference
        )}`
      );
    }
